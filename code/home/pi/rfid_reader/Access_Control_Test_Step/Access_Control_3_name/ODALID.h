...
ODALID_LIB int16_t ISO7816_SelectApplication(ReaderName *Name, uint8_t Type, uint8_t P1, uint8_t P2, uint8_t *AID, uint16_t AID_len, uint8_t *Data, uint16_t *Datalen);
...
ODALID_LIB int16_t SAM_Config_Card_Mode(ReaderName *Name, uint8_t Slot, uint8_t Type);
